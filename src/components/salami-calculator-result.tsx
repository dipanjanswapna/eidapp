            ...
            <div className="relative border-2 border-dashed border-gray-400 bg-gray-50 p-4 sm:p-6 shadow-lg">
                ...
                <div className="relative mt-6 flex flex-col items-center justify-center gap-6">
                    ...
                    <div className="relative">
                        <Stamp className="h-24 w-24 sm:h-28 sm:w-28 text-primary" />
                        <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-12 text-xl sm:text-2xl font-bold text-primary-foreground">
